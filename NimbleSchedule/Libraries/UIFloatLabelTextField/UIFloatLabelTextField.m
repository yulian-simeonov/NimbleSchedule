...
- (void)drawPlaceholderInRect:(CGRect)rect {
    UIColor *colour = [UIColor colorWithRed:150/255.0f green:150/255.0f blue:150/255.0f alpha:1.0];
...
- (void)setupFloatLabel
{
    ...
    _floatLabel.font =[UIFont fontWithName:@"SFUIDisplay-Regular" size:10.0f];
    ...
    _floatLabelActiveColor = [UIColor lightGrayColor];
...
{
    CGFloat top = [self.text length] ? 10.0f : 0.0f;
