...
{
    return [self rangeOfUnit:NSCalendarUnitSecond inUnit:NSCalendarUnitWeekday forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitMinute inUnit:NSCalendarUnitWeekday forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitHour inUnit:NSCalendarUnitWeekday forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitWeekday inUnit:NSCalendarUnitMonth forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitWeekday inUnit:NSCalendarUnitYear forDate:date].length;
}
...
- (BOOL)date:(NSDate *)firstDate isBeforeDate:(NSDate *)anotherDate
{
    ...
    {
//        NSLog(@"(NimbleSchedule | NSCalendar + Ranges) : One of the dates are missing, can't compare.");
        return NO;
    }
